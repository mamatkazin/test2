...
modules.define('c-task-kanban__responsible', ['i-bem-dom'], function(provide, BEMDOM) {
...
//                        this.setMod(this, 'active');
        ...
        _onClick: function() {
            var responsible_id = this.domElem[0].getAttribute('data-id')
              , project_id = g_heap["f_project_id"].toString()
              ;
            
            g_heap['f_responsible_id'] = responsible_id;
            
            $('.c-f-responsibles__item').removeClass('li-active');
            this.domElem.addClass('li-active');
